...
Feature: Réinitialiser MDP US4
	...
	Scenario Outline: Réinitialisation du mot de passe Ok
		...
		And je saisis mon nouveau mot de passe dans le champ de confirmation "<MdpNew>"
		...
		Examples:
		      |LoginReinit                | MdpNew  |Login                     |MDP      |
		      |passwordreinit@yopmail.com |Pmp1989d&|passwordreinit@yopmail.com|Pmp1989d&|
